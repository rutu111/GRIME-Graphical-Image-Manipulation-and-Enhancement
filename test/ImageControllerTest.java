...
public class ImageControllerTest {
  ...
  /**
   * This method is used to check if the output throws an exception with appropriate message if the
   * value of the pixel is greater than 255.
   *
   * @throws Exception illegal argument exception
   */
  @Test
   ...
   * appropriate message if the value of the pixel is less than 0.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This method is used to check if the output throws an exception with
   * appropriate message if the filename is incorrect.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This method is used to check if the output throws an exception with
   * appropriate message if an empty file is loaded.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This method is used to check if the output throws an exception with
   * appropriate message if a file with zero height and width is loaded.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This method is used to check if the output throws an exception with appropriate message if a
   * file with does not have one of the pixels channel.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This is a method is used to check if the command works after empty line.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This method is used to check if the output throws an exception with appropriate message if a
   * file with zero height and width is loaded.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  /**
   * This is a method to test Controller to make sure the Visualize each red component for RGB image
   * works as expected.
   *
   * @throws Exception handles any type of exception
   */
  ...
  /**
   * This method is used to check if the output throws exception with appropriate message if command
   * is incorrect.
   *
  ...
  /**
   * This is a test for the ControllerModel for the sharpen function for JPG. check if hashmap
  ...
  /**
   * This is a test for the ControllerModel for the sharpen function for PNG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the sharpen function for BMP. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function. check if hashmap contains
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function for JPG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function for PNG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the sepia function for BMP. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the sepia function for JPG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the sepia function for PNG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  public void testSepiaPNG() throws Exception {
    ...
    imageController.run();
    String expectedlog = "Received inputs for createBuilderThreeChannel:" + imageName + "\n"
            + "Received inputs for colorTransformationSepia: "
   ...
   * horizontalFlip, verticalFlip, visualize-componenent: red, green check if hashmap contains key
   * and obj, check the size of the hashmap, check if the controller prints the output after
   * operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for all the previous functions: brighten,
   * horizontalFlip, verticalFlip, visualize-component: red, green, blue visualize-component: value,
   * intensity, luma check if hashmap contains key and obj, check the size of the hashmap, check if
  ...
  /**
   * This method is used to check if the output throws an exception with appropriate message if an
   * empty file is loaded.
   *
   * @throws Exception illegal argument exception
   */
  @Test
  ...
  public class MockModel implements Operations {
    ...
    public void combineGreyScaleToRGB(String imageName1, String imageName2, String imageName3,
      ...
      log.append(
          "Received inputs for combineGreyScaleToRGB: " + newImageName + " " + imageName1 + " "
              + imageName2 + " "
              + imageName3 + "\n");
