...
/**
 * This is a class that tests the Model and controller together
 * to make sure the controller is able
 * to get the objects created in the model and performs necessary
 * work to send it to the view.
 */
public class ImageControllerModelTest {

  /**
   * This method is used to check if the load function works as expected,
   * check if hashmap contains
   * key koala and obj, check the size of the hashmap, check if the controller
   * prints the output
   * after operations.
   *
  ...
  /**
   * This method is used to check if the output throws an exception with
   * appropriate message if the
   * value of the pixel is less than 0, check if hashmap does not contains
   * key koala and obj, check
   * the size of the hashmap, check if the controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
   */
   ...
   * check if hashmap
   * contains key and obj, check the size of the hashmap, check if the
   * controller prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
   */
  ...
  /**
   * This is a test for the ControllerModel for the Horizontal flip
   * function. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the
   * controller prints the output
   * after operations.
   *
   ...
   * and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
   *
   * @throws Exception illegal argument exception
   */
  ...
  /**
   * This is a test for the ControllerModel to make sure the Visualize each
  ...
  /**
   * This is a test for the ControllerModel to make sure the Visualize
   * each luma component for RGB,
   * check if hashmap contains key and obj, check the size of the hashmap,
   * check if the controller
   * prints the output after operations.
   *
  ...
  /**
   * This is a test for the ControllerModel to make sure the Visualize
   * each intensity component for
   * RGB, check if hashmap contains key and obj, check the size of the
   * hashmap, check if the
  ...
  /**
   * This is a test for the ControllerModel to make sure splitting RGB
   * into greyscale works as
   * expected, check if hashmap contains key and obj, check the size of
   * the hashmap, check if the
   * controller prints the output after operations.
   *
   * @throws Exception illegal argument exception
   */
  ...
  /**
   * This is a test for the ControllerModel to make sure running the
   * script works as expected, check
   * if hashmap contains key and obj, check the size of the hashmap,
   * check if the controller prints
  ...
  /**
   * This method is used to check if the load function works as
   * expected for jpg format, check if
  ...
  /**
   * This is a test for the ControllerModel for the blur function.
   * check if hashmap contains key and
   * obj, check the size of the hashmap, check if the controller prints
   * the output after
   * operations.
   *
   * @throws Exception illegal argument exception
   ...
   * check if hashmap contains
   * key and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the blur function for
   * BMP. check if hashmap contains
   * key and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
   *
  ...
  /**
   * This is a test for the ControllerModel for the blur function
   * three times on Image. check if
   * hashmap contains key and obj, check the size of the hashmap,
   * check if the controller prints the
  ...
  /**
   * This is a test for the ControllerModel for the sharpen function.
   * check if hashmap contains key
   * and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
   ...
   * This is a test for the ControllerModel for the sharpen function
   * three times on Image. check if
   * hashmap contains key and obj, check the size of the hashmap, check
   * if the controller prints the
   * output after operations.
   *
   * @throws Exception illegal argument exception
   */
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function.
   * check if hashmap contains
   * key and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function for
   * JPG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the c
   * ontroller prints the output
   * after operations
   *
   * @throws Exception illegal argument exception
   */
  ...
  /**
   * This is a test for the ControllerModel for the greyscale function for PNG.
   * check if hashmap
   * contains key and obj, check the size of the hashmap, check if the controller
   * prints the output
   * after operations.
   *
   * @throws Exception illegal argument exception
  ...
  /**
   * This is a test for the ControllerModel for the sepia function for
   * JPG. check if hashmap
   * contains key and obj, check the size of the hashmap, check if the
   * controller prints the output
   * after operations.
  ...
  /**
   * This is a test for the ControllerModel for the dither function.
   * check if hashmap contains key
   * and obj, check the size of the hashmap, check if the controller
   * prints the output after
   * operations.
  ...
  /**
   * This is a test for the ControllerModel for all the previous
   * functions: brighten,
  ...
  /**
   * This is a test for the ControllerModel for all the previous functions:
   * brighten,
   * horizontalFlip, verticalFlip, visualize-component: red, green, blue
   * visualize-component: value,
   * intensity, luma check if hashmap contains key and obj, check the
   * size of the hashmap, check if
   * the controller prints the output after operations.
   *
   * @throws Exception illegal argument exception
   */
   ...
   * expected, check if hashmap contains key and obj, check the size
   * of the hashmap, check if the
   * controller prints the output after operations.
   *
   * @throws Exception illegal argument exception
   */
