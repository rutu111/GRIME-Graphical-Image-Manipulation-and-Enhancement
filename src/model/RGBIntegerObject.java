...
/**
 * The following class represents a RGB object where the RGB values are
...
public class RGBIntegerObject implements TypeofImageObject {
  ...
  /**
   * This is the RGBIntegerObject constructor.
   *
  ...
  /**
   * Hashcode method checks if two RGBIntegerObject integer objects are the same.
   */
  @Override
  public int hashCode() {
    return 0;
