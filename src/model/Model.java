...
/**
 * The following class is the main Model class that the
 * controller deals with.
 *
 * <p>Each method signature throws an exception if the object does
 * nto exist in the hashmap.
 */
public class Model implements Operations {

  /**
   * The following hashmap holds images as values and their
   * names as keys.
   */
