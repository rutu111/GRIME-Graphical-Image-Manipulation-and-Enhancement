 ...
 * ThreeChannelObjectOperations because
 * this is a 3 channel image (we do not any special operations on alpha).
 *
 * <p>The matrix represented in this class is of TypeofImageObject
 * which contains object of type RGBIntegerAlphaObjects. This matrix
 * can be created through the
 * builder (inner class) or directly through the constructor (constructor
 * is private so object can
 * only be created from inside the class or through bulder).
 */
