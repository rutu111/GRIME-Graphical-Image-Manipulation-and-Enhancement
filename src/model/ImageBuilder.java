...
/**
 * Image builder abstract class. This builds a TypeOfImage
 * where the matrix contains
 * TypeOfImageObjects. Any class that extends this abstract
 * class must provide an object P which
...
public abstract class ImageBuilder<P extends TypeofImageObject> {
  ...
  /**
   * The following method inputs a TyepofImageObject at a
