...
/**
 * The following interface represents an image. Common properties that
 * images would have are 1. Tha
 * matrix, 2. The width and 3. The height. This interface has getters for
 * all of these.
 *
 * <p>The interface contains image operations such as Horizontalflip,
 * verticalFlip etc.
 */
